...
/// </summary>
public static class ToggleSwitchExt
{
    /// <summary>
    ...
    public static readonly AttachedProperty<bool> RightAlignedContentProperty =
        AvaloniaProperty.RegisterAttached<ToggleSwitch, bool>("RightAlignedContent", typeof(ToggleSwitch));
    ...
    /// <returns></returns>
    public static bool GetRightAlignedContent(ToggleSwitch toggleSwitch) => toggleSwitch.GetValue(RightAlignedContentProperty);
